...
def menu(acao):
    match acao:
        case 1:
            ...
            return
        case 2:
            indice = int(input("Digite o índice do livro que deseja consultar: "))
            consultar_livro(biblioteca, indice)
            resposta = int(input("O que deseja? \n[1] Voltar ao menu \n[0] Sair"))
            if resposta == 0:
                return
            if resposta == 1:
            ...
            return
        case 3:
            indice = int(input("Digite o índice do livro que deseja pegar emprestado: "))
            pegar_emprestado(biblioteca, indice)
            resposta = int(input("O que deseja? \n[1] Voltar ao menu \n[0] Sair"))
            if resposta == 0:
                return
            if resposta == 1:
